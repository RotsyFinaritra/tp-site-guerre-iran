...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div>
        <a href="/admin/categories/create.php" class="btn btn-sm btn-dark">
        ...
        <table class="table align-middle table-sm mb-0">
            ...
            <?php foreach ($categories as $cat): ?>
                <tr>
                    ...
                    <td class="text-end">
                        <a href="/admin/categories/edit.php?id=<?= (int) $cat['id'] ?>" class="btn btn-outline-secondary btn-xs btn-sm me-1">
                            <i class="bi bi-pencil"></i>
                        </a>
                        <a href="/admin/categories/delete.php?id=<?= (int) $cat['id'] ?>"
